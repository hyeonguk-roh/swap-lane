...
const CarContainer = styled.div<CarContainerProps>`
  ...
  background-color: ${(props) => (props.isCrashed ? "#ff0000" : "#9b4dca")}; // Purple color for drunk buses
...
interface DrunkBusEnemyCarProps {
  car: EnemyCarType;
  position: number;
}

const DrunkBusEnemyCar: React.FC<DrunkBusEnemyCarProps> = ({ car, position }) => {
...
export default DrunkBusEnemyCar; 